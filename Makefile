...
indat-create: indat-createv25.o infile1.o param.h
	gfortran -std=legacy -o indat-create indat-createv25.o infile1.o
indat-createv25.o: indat-createv25.f param.h
	gfortran -std=legacy -c -O indat-createv25.f

#  Build indat-convert.

indat-convert: indat-convertv25.o infile1.o param.h
	gfortran -std=legacy -o indat-convert indat-convertv25.o infile1.o
indat-convertv25.o: indat-convertv25.f param.h
	gfortran -std=legacy -c -O indat-convertv25.f
